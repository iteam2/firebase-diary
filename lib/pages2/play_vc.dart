...
class PlayVideoFromNetwork3 extends StatefulWidget {
  const PlayVideoFromNetwork3({Key? key}) : super(key: key);

  @override
  State<PlayVideoFromNetwork3> createState() => _PlayVideoFromNetwork3State();
}

class _PlayVideoFromNetwork3State extends State<PlayVideoFromNetwork3> {
  ...
  initState() {
    controller = PodPlayerController(
        playVideoFrom: PlayVideoFrom.youtube('https://i.ytimg.com/an_webp/1dhzPuT6jm0/mqdefault_6s.webp?du=3000&sqp=CKT3ppwG&rs=AOn4CLDpHsKoX3Kv8Ig0SUtW_ChaxzZ6vg'),
              ...
              child: SizedBox(height: 280,
                  child: Column(
                    children: [SizedBox(height: 20,),
                      ...
                      content2(define: 'Letter C for You', logo: "https://cdn-icons-png.flaticon.com/512/3524/3524369.png", company: 'iTeam Co-operation')
