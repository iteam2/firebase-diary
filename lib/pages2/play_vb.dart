...
class PlayVideoFromNetwork2 extends StatefulWidget {
  const PlayVideoFromNetwork2({Key? key}) : super(key: key);

  @override
  State<PlayVideoFromNetwork2> createState() => _PlayVideoFromNetwork2State();
}

class _PlayVideoFromNetwork2State extends State<PlayVideoFromNetwork2> {
  late final PodPlayerController controller;
  // late final PodPlayerController2 controller1;
  late final String url;
  @override
  initState() {
    controller = PodPlayerController(
        playVideoFrom: PlayVideoFrom.youtube('https://www.youtube.com/watch?v=kzzXROKd-i0'),
  ...
  // @override
  // State({required String vurl}){
  //   controller1=PodPlayerController2(
  //     playVideoFrom: PlayVideoFrom.networkQualityUrls(videoUrls: vurl),
  //     podPlayerConfig: const PodPlayerConfig(
  //       autoPlay: true,
  //       isLooping: false,
              ...
              child: SizedBox(height: 280,
                  child: Column(
                    children: [SizedBox(height: 20,),
                      ...
                      content2(define: 'Letter B for You', logo: "https://i.ytimg.com/an_webp/RoFz9V_BEG4/mqdefault_6s.webp?du=3000&sqp=CIzSppwG&rs=AOn4CLBWIt9N47dj5L7VgYUNpq5gBS0vgQ", company: 'iTeam Co-operation')
