...
class PlayVideoFromNetwork4 extends StatefulWidget {
  const PlayVideoFromNetwork4({Key? key}) : super(key: key);

  @override
  State<PlayVideoFromNetwork4> createState() => _PlayVideoFromNetwork4State();
}

class _PlayVideoFromNetwork4State extends State<PlayVideoFromNetwork4> {
  ...
  initState() {
    controller = PodPlayerController(
        playVideoFrom: PlayVideoFrom.youtube('https://i.ytimg.com/an_webp/nb8DqaQmNWg/mqdefault_6s.webp?du=3000&sqp=CLCQp5wG&rs=AOn4CLDyC8P0fFAlIyidXahp7N4vlvDQOQ'),
              ...
              child: SizedBox(height: 280,
                  child: Column(
                    children: [SizedBox(height: 20,),
                      ...
                      content2(define: 'Letter D for You', logo: "https://i.ytimg.com/an_webp/kzzXROKd-i0/mqdefault_6s.webp?du=3000&sqp=CLXkppwG&rs=AOn4CLADNAshQV1wkcmoQ_NgQX7WwLydkQ", company: 'iTeam Co-operation')
